...
- [2. 설명 및 테스트](#2-설명-및-테스트)
  - [2-a. 로그인 / 유저 등록](#a-로그인--유저-등록)
  - [2-b. 이벤트 보기 / 등록](#b-이벤트-보기--등록)
  - [2-c. 보상 조회 / 등록](#c-보상-조회--등록)
  - [2-d. 보상 요청 조회 / 등록](#d-보상-요청-조회--등록)
- [3. FAQ](#3-faq)
  - [3-a. 이벤트 설계](#a-이벤트-설계)
  - [3-b. 조건 검증 방식](#b-조건-검증-방식)
- [4. 프로젝트 작성 중 겪은 고민](#4-프로젝트-작성-중-겪은-고민)
  - [4-a. 토큰 만료 시간](#a-토큰-만료-시간)
  - [4-b. 캐시 문제](#b-캐시-문제)
  - [4-c. 보상 요청 등록](#c-보상-요청-등록)
